...
[![Latest Version](https://img.shields.io/github/v/release/sooskes/cpp-rock-paper-scissors?label=Latest%20Version)](https://github.com/sooskes/cpp-rock-paper-scissors/releases/latest)

**[⬇️ Install Latest Version](https://github.com/sooskes/cpp-rock-paper-scissors/releases/latest)**
...
1. Download the latest `.exe` from the [latest release](https://github.com/sooskes/cpp-rock-paper-scissors/releases/latest).
2. Launch the game.
